...
POSSIVEIS_JSON = [
    os.path.join(SCRIPT_DIR, "cartao-493400-d2bf9cd438ac.json"),
    r"C:\Users\denil\Desktop\programas Python\cartao\cartao-493400-d2bf9cd438ac.json",
    r"C:\Users\denil\Desktop\programs_Python\cartao\cartao-493400-d2bf9cd438ac.json"
]

CREDENTIALS_FILE = None
for caminho in POSSIVEIS_JSON:
    if os.path.exists(caminho):
        CREDENTIALS_FILE = caminho
        break
